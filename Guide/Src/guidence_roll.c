...
//    30, 0, 1, 0, -1, -1, 0, 1, 0, 80, 80, 80, 80, 70, 70, 70, 70, 0, 0, 0, 0 };
	 //200
//    static const short b_curve[32] = { 0,0,0,0,0,50,200,150,0,-150,-100,50,0,1,0,-1,-1,0,1,0,100,100,100,100,70,70,70,70,0,0,0,0};
  //240
  static const short b_curve[32] = { 0,0,0,0,0,60,240,180,0,-180,-120,60,0,1,0,-1,-1,0,1,0,120,120,120,120,70,70,70,70,0,0,0,0 };
  //280
//   static const short b_curve[32] = { 0,0,0,0,0,70,280,210,0,-210,-140,70,0,1,0,-1,-1,0,1,0,140,140,140,140,70,70,70,70,0,0,0,0 };
  judge_tmp = (int)*judge;
  for (i0 = 0; i0 < 8; i0++) {
