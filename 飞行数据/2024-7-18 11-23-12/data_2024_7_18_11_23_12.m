...
mode1 = data.VarName46;
mode2 = data.VarName48;
exp_pitch = data.VarName50;
exp_roll = data.VarName52;
exp_yaw = data.VarName54;
exp_thrust = data.VarName56;
exp_height = data.VarName58;
servo_pitch = data.VarName60;
servo_roll = data.VarName62;
servo_yaw = data.VarName64;
spitch = data.VarName66;
sroll = data.VarName68;
syaw = data.VarName70;
%%
clear;
close all;
clc;
load('data_2024_7_18_11_11_16.mat');
%%
%全部数据绘制
close all;
figure(1);
