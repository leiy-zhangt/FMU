...
void delay_us(uint32_t us)
{
    ...
    ((SysTick_Type *) ((0xE000E000UL) + 0x0010UL) )->LOAD = 21*us-1;
    ((SysTick_Type *) ((0xE000E000UL) + 0x0010UL) )->CTRL |= 0X01;
    while(1)
    {
        if(((((SysTick_Type *) ((0xE000E000UL) + 0x0010UL) )->CTRL)&(1<<16))) break;
    }
    ((SysTick_Type *) ((0xE000E000UL) + 0x0010UL) )->CTRL &= 0X00000000;
}
