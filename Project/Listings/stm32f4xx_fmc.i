...
# 687 "..\\Basic\\inc\\stm32f4xx_fmc.h"

# 694 "..\\Basic\\inc\\stm32f4xx_fmc.h"
...
# 955 "..\\Basic\\inc\\stm32f4xx_fmc.h"

# 963 "..\\Basic\\inc\\stm32f4xx_fmc.h"
...
# 1054 "..\\Basic\\inc\\stm32f4xx_fmc.h"

# 1061 "..\\Basic\\inc\\stm32f4xx_fmc.h"

# 1068 "..\\Basic\\inc\\stm32f4xx_fmc.h"
...
# 37 "..\\Basic\\src\\stm32f4xx_fmc.c"
# 38 "..\\Basic\\src\\stm32f4xx_fmc.c"
...
{ 
  ...
  else    
  {
    ...
    tmpr4 =   (uint32_t)(((FMC_SDRAMInitStruct->FMC_SDRAMTimingStruct->FMC_RowCycleDelay)-1) << 12) |
            ...
            FMC_Bank5_6->SDTR[((uint32_t)0x00000000)] = tmpr4;
            FMC_Bank5_6->SDTR[FMC_SDRAMInitStruct->FMC_Bank] = tmpr2;
  }
