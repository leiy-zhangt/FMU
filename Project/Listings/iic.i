# 1 "..\\Connectivity\\IIC\\iic.c"
# 1 "..\\Connectivity\\IIC\\iic.h"
...
# 5 "..\\Connectivity\\IIC\\iic.h"




# 23 "..\\Connectivity\\IIC\\iic.h"
...
void I2C_SendByte(I2C_TypeDef* I2C,uint8_t SlaveAddr,uint8_t WriteAddr,uint8_t Data)
{
    ...
    while(!I2C_CheckEvent(I2C,((uint32_t)0x00030001)));
    I2C_Send7bitAddress(I2C,SlaveAddr,((uint8_t)0x00));
    while(!I2C_CheckEvent(I2C,((uint32_t)0x00070082)));
    I2C_SendData(I2C,WriteAddr);
    while(!I2C_CheckEvent(I2C,((uint32_t)0x00070084)));    
...
void I2C_SendBuffer(I2C_TypeDef* I2C,uint8_t SlaveAddr,uint8_t WriteAddr,uint8_t *buffer,u16 length)
{
    while(I2C_GetFlagStatus(I2C,((uint32_t)0x00020000)));
    I2C_GenerateSTART(I2C,ENABLE);
    while(!I2C_CheckEvent(I2C,((uint32_t)0x00030001)));	
	I2C_Send7bitAddress(I2C,SlaveAddr, ((uint8_t)0x00)); 
	while(!I2C_CheckEvent(I2C,((uint32_t)0x00070082)));
...
{ 
	...
	I2C_GenerateSTART(I2C,ENABLE);
	while(!I2C_CheckEvent(I2C,((uint32_t)0x00030001)));
	I2C_Send7bitAddress(I2C,SlaveAddr,((uint8_t)0x01));
	while(!I2C_CheckEvent(I2C,((uint32_t)0x00030002)));
	I2C_AcknowledgeConfig(I2C,DISABLE); 
	I2C_GenerateSTOP(I2C,ENABLE);	
    while(!I2C_CheckEvent(I2C,((uint32_t)0x00030040)));
...
{ 
    ...
    while(length){
        ...
        if(I2C_CheckEvent(I2C,((uint32_t)0x00030040))){ 
