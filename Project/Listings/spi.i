...
{		 			 
    while (SPI_I2S_GetFlagStatus(SPI,((uint16_t)0x0002)) == RESET){}
    SPI_I2S_SendData(SPI, Data); 
    while (SPI_I2S_GetFlagStatus(SPI,((uint16_t)0x0001)) == RESET){} 
