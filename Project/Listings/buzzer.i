# 1 "..\\HardWare\\BUZZER\\buzzer.c"
# 1 "..\\HardWare\\BUZZER\\buzzer.h"
...
void BUZZER_Configuration(void)
{
    ...
    *((volatile unsigned long *)((((((((uint32_t)0x40000000) + 0x00020000) + 0x0000)+20) & 0xF0000000)+0x2000000+(((((((uint32_t)0x40000000) + 0x00020000) + 0x0000)+20) &0xFFFFF)<<5)+(1<<2)))) = 0;
}
