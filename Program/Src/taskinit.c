...
//			printf("p=%0.4f,r=%0.4f,y=%0.4f,sp=%0.4f,sr=%0.4f,sy=%0.4f\r\n",IMUData.tran_pitch,IMUData.tran_roll,IMUData.tran_yaw,NevAttitudeData.tran_pitch,NevAttitudeData.tran_roll,NevAttitudeData.tran_yaw);
//			printf("p=%0.4f,r=%0.4f,y=%0.4f,sp=%0.4f,sr=%0.4f,sy=%0.4f\r\n",IMUData.tran_pitch,IMUData.tran_roll,IMUData.tran_yaw,NevAttitudeData.pitch,NevAttitudeData.roll,NevAttitudeData.yaw);
//			printf("p=%0.4f,r=%0.4f,y=%0.4f,sp=%0.4f,sr=%0.4f,sy=%0.4f\r\n",IMUData.pitch,IMUData.roll,IMUData.yaw,NevAttitudeData.pitch,NevAttitudeData.roll,NevAttitudeData.yaw);
