...
uint16_t ReceiverChannelPrevious[16]={1500,1500,1000,1500,1000,1500,1500,1500,1500,1500,1500,1500,1500,1500,1500,1500};//Receiver接收通道之前数据
uint16_t ReceiverChannelNeutral[16] = {1500,1500,1000,1500,1000,1500,1500,1500,1500,1500,1500,1500,1500,1500,1500,1500};//Receiver接收通道中立数据
