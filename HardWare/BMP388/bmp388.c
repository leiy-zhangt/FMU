...
void BMP388_Configuration(void)
{
  ...
  while(BMP388_ReadData(0x03)&0x020);
  height_init = 44330.77*(1-pow(BMP388_Data.pre/101325, 1/5.255));
}
...
//  BMP388_TemperatureGet(&BMP388_Data);
  BMP388_PressureGet(&BMP388_Data);
//  return (1-pow(BMP388_Data.pre/pre_init,const1_init))*const2_init;
//  44330.77*(1-pow(BMP388_Data.pre/101325, 1/5.255));
  return 44330.77*(1-pow(BMP388_Data.pre/101325, 1/5.255)) - height_init;
}
