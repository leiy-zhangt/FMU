...
//		ServoSet(ServoChannel_4,20);
//		ServoSet(ServoChannel_5,20);
...
/* USER CODE END MX_GPIO_Init_1 */
  ...
  HAL_GPIO_WritePin(GPIOE, IMU_D0_Pin|IMU_D1_Pin|IMU_D2_Pin|IMU_D3_Pin
                          |RS232_IO1_Pin|RS232_IO2_Pin, GPIO_PIN_RESET);

  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOE, SPI2_CS_Pin|SIGNAL_Pin|RS232_OFF_Pin|RS232_ON_Pin, GPIO_PIN_SET);
  ...
  /*Configure GPIO pins : IMU_D0_Pin IMU_D1_Pin IMU_D2_Pin IMU_D3_Pin
                           SIGNAL_Pin RS232_IO1_Pin RS232_IO2_Pin */
  GPIO_InitStruct.Pin = IMU_D0_Pin|IMU_D1_Pin|IMU_D2_Pin|IMU_D3_Pin
                          |SIGNAL_Pin|RS232_IO1_Pin|RS232_IO2_Pin;
  ...
  /*Configure GPIO pin : SPI2_IO_Pin */
  GPIO_InitStruct.Pin = SPI2_IO_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_PULLDOWN;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  HAL_GPIO_Init(SPI2_IO_GPIO_Port, &GPIO_InitStruct);

  /*Configure GPIO pin : S_EN_Pin */
  GPIO_InitStruct.Pin = S_EN_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_OD;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  HAL_GPIO_Init(S_EN_GPIO_Port, &GPIO_InitStruct);

  /*Configure GPIO pins : ADXL_CS_Pin ADXL_INT_Pin */
  GPIO_InitStruct.Pin = ADXL_CS_Pin|ADXL_INT_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_PULLUP;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_HIGH;
  HAL_GPIO_Init(GPIOC, &GPIO_InitStruct);

  /*Configure GPIO pins : TELEM2_IO1_Pin TELEM2_IO2_Pin TELEM3_IO2_Pin TELEM3_IO1_Pin */
  GPIO_InitStruct.Pin = TELEM2_IO1_Pin|TELEM2_IO2_Pin|TELEM3_IO2_Pin|TELEM3_IO1_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_PULLDOWN;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  HAL_GPIO_Init(GPIOB, &GPIO_InitStruct);

  /*Configure GPIO pins : RS232_VALID_Pin RS232_RDY_Pin */
  GPIO_InitStruct.Pin = RS232_VALID_Pin|RS232_RDY_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_INPUT;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  HAL_GPIO_Init(GPIOE, &GPIO_InitStruct);

  /*Configure GPIO pins : RS232_OFF_Pin RS232_ON_Pin */
  GPIO_InitStruct.Pin = RS232_OFF_Pin|RS232_ON_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  HAL_GPIO_Init(GPIOE, &GPIO_InitStruct);
  ...
  /*Configure GPIO pins : TELEM1_IO2_Pin TELEM1_IO1_Pin */
  GPIO_InitStruct.Pin = TELEM1_IO2_Pin|TELEM1_IO1_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_PULLDOWN;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  HAL_GPIO_Init(GPIOD, &GPIO_InitStruct);
